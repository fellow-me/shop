			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin_index.jsp">首页</a><span
						...
						href="AdminGetProduct">商品管理</a><span class="crumb-step">&gt;</span><span>商品修改</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="AdminProductUpdate" method="post" id="myform"
							...
							<tbody>
												...
												<c:if test="${category.parentId == 0}">
													...
													<c:forEach var="category1" items="${list }">
														<c:if test="${category1.parentId == category.id }">
															<c:if test="${product.category.id == category1.id}">
								...
								<tr>
									...
									<td><textarea name="detail" class="common-textarea"
											id="content" cols="30" style="width: 78%;" rows="10">${product.detail }</textarea></td>
								</tr>
								<tr>
									<th></th>
