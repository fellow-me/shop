			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin_index.jsp">首页</a><span
						...
						href="AdminGetCategory">分类管理</a><span class="crumb-step">&gt;</span><span>更新分类</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="AdminCategoryUpdate" method="post" id="myform"
						name="myform">
							...
							<tbody>
									...
									<td><select class="common-text required" name="parentId">
											...
											<c:if test="${category.parentId != 0 }">
												<c:forEach var="category1" items="${list}">
													<c:if test="${category1.parentId == 0}">
														<c:if test="${category.parentId == category1.id}">
								...
								<tr>
									...
									<td><input class="common-text required" name="name"
										size="50" value="${category.name }" type="text"></td>
								</tr>
								<tr>
									<th></th>
