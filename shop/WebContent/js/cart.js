$(function () {
    $(".num .sub").click(function () {
        ...
        if (c <= 1) {
			...
			if(typeof $(this).siblings("span").attr('cartId')!="undefined"){
				var url = "CartUpdate?amount="+c+"&id="+$(this).siblings("span").attr('cartId');
				$.get(url,function(){});
			}
    ...
    $(".num .add").click(function () {
        var c = parseInt($(this).siblings("span").text());
		var stock = parseInt($(this).siblings("span").attr('stock'))
		if(c >= stock){
			confirm("商品库存有限！")
		}else{
        c++;
