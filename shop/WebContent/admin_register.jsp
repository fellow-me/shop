...
<body>
	<div class="admin_login_wrap">
			...
			<div class="admin_input">
				<form action="AdminRegister" method="post">
					<ul class="admin_items">
						...
						<li><label for="pwd">输入密码：</label> <input type="password"
							name="password" value="" id="pwd" size="40"
							class="admin_input_style" /></li>
						<li><label for="pwd">确认密码：</label> <input type="password"
							name="repassword" value="" id="pwd" size="40"
							class="admin_input_style" /></li>
		...
		<p class="admin_copyright">
			<a tabindex="5" href="admin_login.jsp">登录</a> &copy; 2020 Powered by
			Judy
		</p>
	</div>
</body>
